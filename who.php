  ...
  <body id="who">
    ...
    <div class="wrapper-who">
        <div class="header">
            ...
            <nav>
                <ul class="menu">
                    <li><a class="current" href="who.php">COV</a></li>
                    <li><a href="">JJOO</a></li>
    ...
    <div class="body">
        <div class="container">
            <div class="row"><img src="./img/quienes-somos.png" /></div>
            <div class="col large-1">
                <div class="team">
                    <div class="member">
                        <img src="./img/directivo-8.png" />
                    </div>
                    <div class="member">
                        <img src="./img/directivo-7.png" />
                    </div>
                    <div class="member">
                        <img src="./img/directivo-6.png" />
                    </div>
                    <div class="member">
                        <img src="./img/directivo-4.png" />
                    </div>
                    <div class="member">
                        <img src="./img/directivo-9.png" />
                    </div>
                    <div class="member">
                        <img src="./img/directivo-5.png" />
                    </div>
                    <div class="member">
                        <img src="./img/directivo-3.png" />
                    </div>
                    <div class="member">
                        <img src="./img/directivo-2.png" />
                    </div>
                    <div class="member">
                        <img src="./img/directivo-1.png" />
                    </div>
                </div>
                <div>
                    <ul class="nav">
